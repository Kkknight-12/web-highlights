...
async function handleExport() {
  ...
  showExportDialog(hasPageHighlights, hasAllHighlights)
}

// Show export format and scope dialog
function showExportDialog(hasPageHighlights, hasAllHighlights) {
  ...
  dialog.querySelector('.export-confirm').addEventListener('click', () => {
    ...
    if (format === 'json') {
      exportAsJSON(highlightsToExport, scope)
    } else {
      exportAsText(highlightsToExport, scope)
    }
  })
...
function exportAsJSON(highlights, scope) {
  const data = {
...
function exportAsText(highlights, scope) {
