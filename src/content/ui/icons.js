/**
 * Feather Icons for the extension
...
export const ICONS = {
  ...
  // Palette icon
  palette: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
           '<circle cx="13.5" cy="6.5" r="3.5"></circle>' +
           '<circle cx="6.5" cy="12" r="2.5"></circle>' +
           '<circle cx="18.5" cy="12" r="2.5"></circle>' +
           '<circle cx="12" cy="18.5" r="3.5"></circle>' +
           '</svg>',
  ...
  // Highlighter icon
  highlighter: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' +
